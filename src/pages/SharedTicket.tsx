      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div><h2 className="font-medium text-foreground mb-2">Beskrivning</h2><div className="bg-muted/30 p-4 rounded-lg"><MarkdownRenderer content={ticket.description} /></div></div>
            ...
            {ticket.solution && <div className="pt-4 border-t"><div className="flex items-center gap-2 mb-2"><Lightbulb className="w-4 h-4 text-primary" /><h2 className="font-medium text-foreground">Lösning</h2></div><div className="bg-primary/5 border border-primary/20 p-4 rounded-lg"><MarkdownRenderer content={ticket.solution} /></div></div>}
            {ticket.notes && (
              <div className="pt-4 border-t">
                <h2 className="font-medium text-foreground mb-2">Anteckningar</h2>
