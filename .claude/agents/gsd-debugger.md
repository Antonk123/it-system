...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /sessions/zealous-magical-hamilton/mnt/it-system/.claude
                  → checks /sessions/zealous-magical-hamilton/mnt/it-system/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done
                  → writes to /sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
