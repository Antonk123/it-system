...
<!-- For checkpoint task examples and patterns, see @/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/references/checkpoints.md -->
...
See `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
