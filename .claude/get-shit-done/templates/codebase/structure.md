...
- Usage: Reference from command with `@/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /sessions/zealous-magical-hamilton/mnt/it-system/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /sessions/zealous-magical-hamilton/mnt/it-system/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
