...
```bash
PHASE_INFO=$(node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/sessions/zealous-magical-hamilton/mnt/it-system/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
