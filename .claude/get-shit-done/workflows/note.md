...
- **Global scope**: `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/notes/`)
...
2. Glob `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/sessions/zealous-magical-hamilton/mnt/it-system/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/sessions/zealous-magical-hamilton/mnt/it-system/.claude/notes/` — works in any directory
